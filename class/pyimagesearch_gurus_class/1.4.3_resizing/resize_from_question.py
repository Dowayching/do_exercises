...
# perform the resize (width = 100) & print specified RGB
r = 100.0 / image.shape[1]
dim = (100, int(image.shape[0] * r))
resized = cv2.resize(image, dim, interpolation=cv2.INTER_NEAREST)
(b, g, r) = resized[74, 20]
print("resize (width=100), (20, 74) = RGB ({}, {}, {})".format (r, g, b))

# perform the resize (twice the size) & print specified RGB
dim = (image.shape[1] * 2, image.shape[0] * 2)
resized = cv2.resize(image, dim, interpolation=cv2.INTER_CUBIC)
(b, g, r) = resized[367, 170]
print("resize (twice the size), (170, 367) = RGB ({}, {}, {})".format (r, g, b))
